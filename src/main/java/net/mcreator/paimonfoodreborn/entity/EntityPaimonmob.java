...
package net.mcreator.paimonfoodreborn.entity;
...
import net.mcreator.paimonfoodreborn.item.ItemPaimonsuper;
import net.mcreator.paimonfoodreborn.ElementsPaimonFoodReborn;

import java.util.Random;

@ElementsPaimonFoodReborn.ModElement.Tag
public class EntityPaimonmob extends ElementsPaimonFoodReborn.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;
	public EntityPaimonmob(ElementsPaimonFoodReborn instance) {
		super(instance, 31);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("paimonfoodreborn", "paimonmob"), ENTITYID)
						.name("paimonmob").tracker(32, 3, true).egg(-13312, -103).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("paimonfoodreborn:paimonbiome")),};
		EntityRegistry.addSpawn(EntityCustom.class, 30, 1, 4, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("paimonfoodreborn:textures/paimon.png");
				}
			};
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected void initEntityAI() {
			super.initEntityAI();
			this.tasks.addTask(1, new EntityAIWander(this, 0.4, 20) {
				@Override
			...
			this.tasks.addTask(6, new EntityAIBase() {
				...
				public void startExecuting() {
					...
					EntityCustom.this.moveHelper.setMoveTo(vec3d.x, vec3d.y, vec3d.z, 0.5);
				}
			...
			this.tasks.addTask(7, new EntityAIPanic(this, 0.7));
			this.tasks.addTask(8, new EntityAIFollow(this, (float) 0.6, 32, 8));
		...
		protected Item getDropItem() {
			return new ItemStack(ItemPaimonsuper.block, (int) (1)).getItem();
		}
